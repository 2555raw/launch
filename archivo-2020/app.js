/* ARCHIVO 2020 — motor de pixel art y las cinco escenas.
   ...
   Cada capítulo es un <canvas> de 384x216 píxeles reales que el navegador
   amplía sin suavizado, así que todo lo que se ve (tipografía incluida) está
   dibujado píxel a píxel. El scroll de cada capítulo se convierte en un
   progreso 0..1 y ese número es el único guion de la escena.
