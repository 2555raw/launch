...
(() => {
  ...
  const LOGOS = {
    ...
    AMZN: { fill: '#111111', mark: 'color', svg: '<rect x="-1" y="3" width="26" height="18" rx="4" fill="#FFFFFF"/><text x="12" y="12.6" font-family="Arial, Helvetica, sans-serif" font-weight="700" font-size="7.6" text-anchor="middle" fill="#111" letter-spacing="-0.3">amazon</text><path d="M4.6 15.2 C8.4 18.2 15.2 18.4 19.2 15.6" fill="none" stroke="#FF9900" stroke-width="1.7" stroke-linecap="round"/><path d="M18.1 14.6 L20.1 15.5 L18.4 16.6" fill="none" stroke="#FF9900" stroke-width="1.7" stroke-linecap="round" stroke-linejoin="round"/>' },
