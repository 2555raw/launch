...
(function () {
  ...
  var I18N = {
    es: {
      'nav.explore': 'Explorar', 'nav.launch': 'Dropear coin', 'nav.pair': 'Crear par', 'nav.exchange': 'Exchange', 'nav.you': 'Tú', 'nav.portfolio': 'Portfolio', 'nav.earnings': 'Ganancias', 'nav.kitchen': 'Cocina (juego)', 'nav.ref': 'Referencia', 'nav.rates': 'Cotizaciones', 'nav.how': 'Cómo funciona', 'side.chain': 'Kitchen Chain · testnet',
      'wallet.connect': 'Conectar cartera', 'wallet.title': 'Conecta una cartera', 'wallet.kitchen': 'Kitchen Wallet', 'wallet.kitchenSub': 'La cartera del juego. Cash: {cash}', 'wallet.soon': 'Próximamente', 'wallet.disconnect': 'Desconectar', 'wallet.connected': 'Cartera conectada', 'wallet.need': 'Conecta la cartera primero',
      'hero.eyebrow': '● Cocínalo. Dropéalo. Trádealo.', 'hero.h1': 'Coins de comida.', 'hero.h2': 'Mercado global.', 'hero.p': 'Descubre y lanza memecoins con nombre de plato. Cada coin nace en la curva de la cocina y se gradúa a PonsV2 o Uniswap. El cash lo ganas en el juego.', 'hero.launch': 'Dropear una coin', 'hero.how': 'Cómo funciona', 'hero.play': 'Jugar y ganar cash',
      'stat.coins': 'Coins indexadas', 'stat.coinsSub': 'en todas las cocinas', 'stat.grad': 'Graduadas', 'stat.gradSub': 'en PonsV2 y Uniswap', 'stat.vol': 'Volumen 24h', 'stat.volSub': 'simulado', 'stat.fee': 'Tasa base', 'stat.feeSub': 'la mitad para el creador',
      'feat.official': 'Oficial', 'feat.on': 'en {dex}, par con {q}', 'feat.price': 'Precio', 'feat.mcap': 'Market cap', 'feat.status': 'Estado', 'feat.trade': 'Tradear {t} en {dex}', 'feat.burned': '{n} {t} quemados · {p}% del supply', 'feat.only': 'La única coin emitida por Crypto Kitchen. Cualquier otra que se llame así es de otro.',
      'market.title': 'Explora el mercado', 'market.sub': 'Encuentra tu próxima coin. Empieza por un plato.', 'market.search': 'Buscar coins, tickers o direcciones', 'market.empty': 'Ninguna coin coincide. Dropea la tuya.',
      'tab.mcap': 'Top market cap', 'tab.new': 'Nuevas', 'tab.vol': 'Más tradeadas', 'tab.curve': 'En la curva', 'col.coin': 'Coin', 'col.price': 'Precio', 'col.mcap': 'Market cap', 'col.status': 'Estado',
      'st.curve': 'Curva', 'st.grad': 'Graduada', 'st.you': 'tuya',
      'coin.back': '‹ Volver al mercado', 'coin.by': 'por {who}', 'coin.you': 'ti', 'coin.liq': 'Liquidez', 'coin.holders': 'Holders', 'coin.vol': 'Vol 24h', 'coin.created': 'Creada', 'coin.supply': 'Supply', 'coin.dex': 'DEX', 'coin.quote': 'Par', 'coin.curveOn': 'Curva de la cocina', 'coin.gradTo': 'Se gradúa a {dex} al recaudar {amt}', 'coin.raised': '{a} de {b} recaudado', 'coin.tradeOn': 'Tradear en {dex} ↗',
      'trade.buy': 'Comprar', 'trade.sell': 'Vender', 'trade.youPay': 'Pagas', 'trade.youGet': 'Recibes', 'trade.fee': 'Comisión', 'trade.impact': 'Impacto', 'trade.route': 'Ruta', 'trade.balance': 'Balance: {b}', 'trade.max': 'Máx', 'trade.go': 'Confirmar {side}', 'trade.done': '{side}: {amt} {t} por {usd}', 'trade.noCash': 'No tienes cash suficiente. Gánalo en la cocina.', 'trade.noTok': 'No tienes tantos {t}.', 'trade.grad': '🎓 ¡{t} se ha graduado a {dex}!',
      'launch.title': 'Dropea una coin de comida', 'launch.sub': 'Elige un plato, ponle ticker y sale a la curva de la cocina. Cuando recauda $12,000 se gradúa al DEX que elijas.', 'launch.emoji': 'Plato', 'launch.name': 'Nombre', 'launch.ticker': 'Ticker', 'launch.desc': 'Descripción', 'launch.descPh': 'Frito, azucarado y a la luna.', 'launch.quote': 'Par', 'launch.dex': 'DEX de graduación', 'launch.buy': 'Compra inicial (USD)', 'launch.fee': 'Tasa de lanzamiento', 'launch.submit': 'Dropear coin', 'launch.preview': 'Vista previa', 'launch.startPrice': 'Precio inicial', 'launch.startMcap': 'Market cap inicial', 'launch.yourBag': 'Tu bolsa', 'launch.cost': 'Coste total', 'launch.steps': 'Qué pasa al dropear', 'launch.s1': 'Se crea el token con 1,000,000,000 de supply en la curva de la cocina.', 'launch.s2': 'Tu compra inicial entra la primera: eres el primer holder.', 'launch.s3': 'Con $12,000 recaudados, la liquidez se manda al DEX y se quema el LP.', 'launch.s4': 'Cobras el 0.5% de cada trade mientras esté en la curva.', 'launch.done': '🚀 {t} dropeada. Ya está en la curva.', 'launch.taken': 'Ese ticker ya existe.', 'launch.needCash': 'Necesitas {amt} de cash. Gánalo en la cocina.',
      'pair.title': 'Crear un par', 'pair.sub': 'Añade liquidez a una coin graduada en PonsV2 o Uniswap. Recibes LP y el 0.25% de cada swap del par.', 'pair.coin': 'Coin', 'pair.amount': 'Liquidez (USD)', 'pair.submit': 'Crear par', 'pair.yours': 'Tus pares', 'pair.none': 'Todavía no has creado ningún par.', 'pair.done': 'Par {t}/{q} creado en {dex}.', 'pair.needGrad': 'Solo las coins graduadas pueden tener par en un DEX.',
      'swap.title': 'Exchange', 'swap.from': 'Vendes', 'swap.to': 'Compras', 'swap.go': 'Swap', 'swap.routes': 'Rutas', 'swap.routesSub': 'Se cotiza en cada DEX y se ejecuta en la mejor.', 'swap.best': 'Mejor', 'swap.same': 'Elige dos activos distintos.', 'swap.cash': 'Cash (USD)',
      'pf.title': 'Portfolio', 'pf.total': 'Valor total', 'pf.cash': 'Cash de la cocina', 'pf.coins': 'Coins de comida', 'pf.game': 'Crypto del juego', 'pf.holdings': 'Posiciones', 'pf.none': 'Sin posiciones. Compra una coin o dropea la tuya.', 'pf.cta': 'Más cash: sirve más pedidos', 'pf.ctaSub': 'Cada turno del juego suma cash a esta cartera.',
      'earn.title': 'Ganancias', 'earn.creator': 'Comisiones de creador', 'earn.creatorSub': '0.5% de cada trade en tus coins', 'earn.lp': 'Comisiones LP', 'earn.lpSub': '0.25% de cada swap en tus pares', 'earn.kitchen': 'Ganado en la cocina', 'earn.kitchenSub': '{n} pedidos servidos', 'earn.yourCoins': 'Tus coins', 'earn.none': 'Todavía no has dropeado ninguna coin.', 'earn.claim': 'Reclamar', 'earn.claimed': '{amt} reclamados a tu cash.',
      'kitchen.title': 'La cocina', 'kitchen.sub': 'Los clientes pagan en crypto; lo que ganas aquí es el cash que gastas en el launchpad.', 'kitchen.full': 'Abrir a pantalla completa ↗',
      'rates.title': 'Cotizaciones', 'rates.sub': 'Los activos en los que pagan los clientes y con los que se emparejan las coins.', 'rates.asset': 'Activo', 'rates.price': 'Precio', 'rates.index': 'Índice de comida', 'rates.indexSub': 'Las diez coins más grandes, ponderadas por market cap.',
      'how.title': 'Cómo funciona', 'how.1': 'Gana cash en la cocina', 'how.1p': 'Juega un turno: los clientes pagan en BTC, ETH, SOL, DOGE o USDC y el total entra como cash en tu Kitchen Wallet.', 'how.2': 'Dropea una coin', 'how.2p': 'Elige un plato, ticker y DEX. La coin sale a la curva de la cocina con 1B de supply y tú eres el primer holder.', 'how.3': 'Se gradúa', 'how.3p': 'Al recaudar $12,000, la liquidez se envía a PonsV2 o Uniswap v3 y se quema el LP. Desde ahí se tradea como cualquier token.', 'how.4': 'Cobra comisiones', 'how.4p': 'El creador cobra el 0.5% de cada trade en la curva; quien crea pares cobra el 0.25% de cada swap.',
      'faq.1': '¿Esto es real?', 'faq.1p': 'No. Es un launchpad simulado: las coins, el mercado y la cartera viven en tu navegador. PonsV2 y Uniswap aparecen como destino de graduación a modo de demo; nada se envía a una cadena real.', 'faq.2': '¿De dónde sale el cash?', 'faq.2p': 'De la cocina. Cada pedido servido en el juego suma dólares a la Kitchen Wallet, que es la misma cartera que usas aquí.', 'faq.3': '¿Qué DEX conviene?', 'faq.3p': 'PonsV2 cobra 0.25% por swap y Uniswap v3 0.30%. En el Exchange se cotizan los dos y se ejecuta en el mejor.', 'faq.4': '¿Puedo perder?', 'faq.4p': 'Sí: es una curva. Si compras alto y vendes bajo, tu cash baja. Es un juego, pero las matemáticas son las de verdad.',
      'toast.copied': 'Dirección copiada', 'status.grad': 'Graduada', 'status.curve': 'En la curva'
    },
    en: {
  ...
  var lang = 'es';
  function t(k, v) { var s = (I18N[lang] && I18N[lang][k]) || I18N.es[k] || k; if (v) s = s.replace(/\{(\w+)\}/g, function (m, x) { return v[x] !== undefined ? v[x] : m; }); return s; }
  function applyLang() {
  ...
  lang = ['es', 'en', 'zh'].indexOf(q) !== -1 ? q : ['es', 'en', 'zh'].indexOf(game.lang) !== -1 ? game.lang : nav.indexOf('zh') === 0 ? 'zh' : nav.indexOf('es') === 0 ? 'es' : 'en';
  game.lang = lang;
