...
def ping(at, buf, note=987.77, gain=0.24):
...
# E minor: the root and the fifth underneath, a pentatonic figure above.
E1, E2, G2, B2, D3 = 41.20, 82.41, 98.00, 123.47, 146.83
FIGURE = [659.25, 987.77, 783.99, 587.33, 493.88, 783.99, 659.25, 440.00]
...
def render(seconds):
    ...
    for b in range(bars):
        ...
        root = E1 if b % 8 < 6 else 36.71                # E, then D for the fall
