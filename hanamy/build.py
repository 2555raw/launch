...
<div class="talk">
  ...
  <div class="wire" id="t-wire" hidden>
    <div class="wire-in">
      <p class="sub" id="t-why">A key from <a href="https://openrouter.ai/keys" target="_blank"
        rel="noopener">OpenRouter</a> or <a href="https://platform.openai.com/api-keys"
        target="_blank" rel="noopener">OpenAI</a>. It stays in this browser.</p>
