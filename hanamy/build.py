      ...
      <div class="wire-up" id="wire" hidden>
        ...
        <div class="split tight" style="gap:16px">
          <div class="field"><label for="w-base">Base URL</label>
            <input type="text" id="w-base" placeholder="https://api.groq.com/openai/v1"></div>
...
<div class="talk">
  ...
  <div class="wire" id="t-wire" hidden>
    <div class="wire-in">
      <p class="sub" id="t-why">A free key from <a href="https://console.groq.com/keys"
        target="_blank" rel="noopener">Groq</a> or <a href="https://aistudio.google.com/apikey"
        target="_blank" rel="noopener">Google AI Studio</a>, or a paid one from anywhere that
        speaks the OpenAI format. It stays in this browser.</p>
      <p class="sub" id="t-why-hosted" hidden>This site carries its own key, so you need nothing.</p>
      <div class="wire-row">
        <label class="field"><span>Base URL</span>
          <input type="text" id="t-base" placeholder="https://api.groq.com/openai/v1"></label>
