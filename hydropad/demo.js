 ...
 *
 * When no wallet or no network is available, Hydropad can run a real EVM in the
...
const DemoChain = {
  JOURNAL: "hydropad.demo.journal",
  FLAG: "hydropad.demo.on",
  OPTED_OUT: "hydropad.demo.off",
  CHAIN_ID: 1337,
  MAX_TXS: 200,
  ...
  disable() {
    try {
      ...
      localStorage.removeItem(`hydropad.launcher.${this.CHAIN_ID}`);
    } catch (_) {}
  },
