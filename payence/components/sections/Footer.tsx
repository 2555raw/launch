import { XMark, X_URL, X_HANDLE } from "../ui/XLink";
      ...
      <div className="shell">
            ...
            <ul className="mt-5 space-y-3">
              <li>
                <a
                  ...
                  className="inline-flex items-center gap-2 text-[14px] text-canvas/70 transition-colors duration-200 hover:text-coral"
                >
                  <XMark size={13} />
                  {X_HANDLE}
                </a>
        ...
        <div className="mt-16 flex flex-col gap-4 border-t border-hairDark pt-7 md:flex-row md:items-center md:justify-between">
          <p className="font-mono text-[11px] leading-relaxed text-canvas/40">
            © {year} Payence Technologies. All rights reserved. Sample figures throughout.
          </p>
