...
Static site for **Propello**: a share of the rent from ten apartment buildings in eight
European cities, held through one vault token, `vPROP`.
...
vPROP balance, the share price and what the vault holds straight from the contract
