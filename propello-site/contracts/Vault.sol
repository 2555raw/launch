...
/// @title  Propello Vault — an ERC-4626 share of rented apartments.
/// @notice One vault, one token (vPROP), one price. The price is what the
...
contract Vault {
    // ------------------------------------------------------------ token ---
    string public constant name = "Propello Vault Share";
    string public constant symbol = "vPROP";
