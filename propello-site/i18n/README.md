...
The site ships in English and Chinese (`zh/`). A language is two dictionaries here —
...
```
node scripts/translate.js --lang zh && node scripts/render-static.js     # or: npm run i18n
```
