/* ===========================================================================
   RENTA — the eligibility gate. Before a wallet is connected for the first
...
(function () {
  ...
  window.RENTA_GATE = { open: open, accepted: accepted, reset: function () { try { localStorage.removeItem(KEY); } catch (e) {} } };
})();
