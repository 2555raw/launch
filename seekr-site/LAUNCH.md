...
3. Wait for the redeploy, then check on seekr.website:
   ...
   - on `/token`: the contract address shows with a Copy button, Price, 24H, Market cap, Liquidity and 24H volume show numbers, and "Buy on Pons" and "Chart" open the right pages
