...
const api = {
  ...
  'GET /api/config': async () => ({
    ...
    chain: { id: config.chain.rhChainId, token: config.chain.seekrToken, buyUrl: config.chain.buyUrl, chartUrl: config.chain.chartUrl, launch: config.chain.launch, launchAt: config.chain.launchAt, explorer: config.chain.explorer },
    links: config.links,
