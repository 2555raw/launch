...
(async () => {
  ...
  const factory = new ethers.ContractFactory(Spillway.abi, Spillway.bytecode, a);
  ...
  const iface = new ethers.Interface(Spillway.abi);
  ...
  const erc = new ethers.Contract(token, SpillwayToken.abi, a);
